...
//       title: 'Halaman Verifikasi Sertifikasi',
//       theme: ThemeData(
//         colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFF0B2F9F)),
//         useMaterial3: true,
//       ),
//       home: const VerifikasiSertifikasi(title: 'SERTIPEDIA'),
//       routes: {
...
class _VerifikasiSertifikasiState extends State<VerifikasiSertifikasi> {
  List<Map<String, String>> items = [
    {'no': '1', 'bidang': 'Data Science', 'penyelenggara': 'Gobelins Paris', 'durasi': '12 Hari'},
    {'no': '2', 'bidang': 'Web Development', 'penyelenggara': 'Harvard University', 'durasi': '8 Hari'},
    {'no': '3', 'bidang': 'Mobile Development', 'penyelenggara': 'Stanford University', 'durasi': '10 Hari'},
  ];
